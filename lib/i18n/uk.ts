...
export const uk: StringsOverlay = {
  ...
  games: {
    ...
    addGuests: {
      ...
      guestOne: "1 гість",
      guestMany: "{n} гостей",
      payCredit: "Оплатити з гаманця",
      payOnline: "Оплатити онлайн",
      creditAfter: "Залишиться {amount}",
      notEnoughCredit: "Не вистачає кредиту на стільки гостей",
  ...
  payment: {
    ...
    checkoutCredits: "{credits} кредитів у гаманець",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Як оплатити?",
        a: "Оплати карткою або мобільним гаманцем під час бронювання, або скористайся кредитами з абонемента.",
      },
      {
