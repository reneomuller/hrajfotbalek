...
export const ru: StringsOverlay = {
  ...
  games: {
    ...
    spotsLeftOne: "{n} место свободно",
    spotsLeftFew: "{n} места свободно",
    spotsLeftMany: "{n} мест свободно",
    full: "Мест нет",
    durationMin: "{n} мин",
    past: "Завершено",
    ...
    subsPerTeamOne: "{n} запасной на команду",
    subsPerTeamFew: "{n} запасных на команду",
    subsPerTeamMany: "{n} запасных на команду",
    skillLevel: {
      beginner: "Новичок",
    ...
    gamesPlayedFew: "{n} матча",
    gamesPlayedMany: "{n} матчей",
  ...
  notifications: {
    ...
    kinds: {
      no_show_warning: {
        title: "Тебя отметили как неявку",
        body:
          "У тебя было место, но ты не пришёл — и никто из листа ожидания его не получил. " +
          "В следующий раз отмени заранее: место сразу вернётся им.",
      },
      no_show_cleared: {
        title: "Отметку о неявке сняли",
        body: "Организатор поправил состав. Ничего за тобой не числится.",
      },
    },
  },
  ...
  faq: {
    ...
    items: [
      {
        q: "Что взять с собой?",
        // Round 17 item 4 — DRAFT. Ротация вратарей перенесена сюда со страницы игры.
        a: "Обувь и себя. Манишки, перчатки и мячи мы обеспечиваем — вратари меняются, так что свои никому не нужны.",
      },
      {
        q: "Как оплатить?",
      ...
      },
      {
        ...
        a: "Встань в лист ожидания. Как только место освободится, мы напишем на почту всем в списке — место достанется тому, кто заберёт его первым.",
      },
      {
        q: "Нужно ли хорошо играть?",
        // Round 17 item 4 — DRAFT.
        a: "Ждём игроков любого уровня; игры дружеские, если у игры не указан конкретный уровень. Вратари и замены идут по очереди, так что каждый как следует поиграет."
      },
    ],
  },
};
