...
export const cs: StringsOverlay = {
  ...
  games: {
    ...
    spotsLeftOne: "{n} volné místo",
    spotsLeftFew: "{n} volná místa",
    spotsLeftMany: "{n} volných míst",
    full: "Obsazeno",
    durationMin: "{n} min",
    past: "Odehráno",
    ...
    subsPerTeamOne: "{n} náhradník na tým",
    subsPerTeamFew: "{n} náhradníci na tým",
    subsPerTeamMany: "{n} náhradníků na tým",
    skillLevel: {
      beginner: "Začátečník",
    ...
    gamesPlayedOne: "{n} zápas",
    gamesPlayedFew: "{n} zápasy",
    gamesPlayedMany: "{n} zápasů",
